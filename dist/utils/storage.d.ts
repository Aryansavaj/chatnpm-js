...
export declare const getExistingResultIdFromStorage: (chat77submoduleId?: string) => string | undefined;
export declare const setResultInStorage: (storageType?: "local" | "session") => (chat77submoduleId: string, resultId: string) => void;
export declare const getInitialChatReplyFromStorage: (chat77submoduleId: string | undefined) => {
    messages: ({
        id: string;
    } & ({
...
export declare const setInitialChatReplyInStorage: (initialChatReply: StartChatResponse, { chat77submoduleId, storage, }: {
...
export declare const wipeExistingChatStateInStorage: (chat77submoduleId: string) => void;
