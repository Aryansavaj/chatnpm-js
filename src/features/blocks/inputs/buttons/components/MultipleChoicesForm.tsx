...
import { defaultChoiceInputOptions } from "@chat77npm/blocks-inputs/choice/constants";
          ...
          {(item) => (
            <span class={"relative" + (isMobile() ? " w-full" : "")}>
              <div
                ...
                class={
                  "w-full py-2 px-4 font-semibold focus:outline-none cursor-pointer select-none chat77submodule-selectable" +
          ...
          {(selectedItemId) => (
            <span class={"relative" + (isMobile() ? " w-full" : "")}>
              <div
                ...
                class={
                  "w-full py-2 px-4 font-semibold focus:outline-none cursor-pointer select-none chat77submodule-selectable selected"
                }
