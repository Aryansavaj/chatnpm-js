...
import { hexToRgb } from "@chat77npm/lib/hexToRgb";
import { defaultButtonsBackgroundColor } from "@chat77npm/theme/constants";
...
export const VoiceRecorder = (props: Props) => {
  ...
  return (
    <div
      class={clsx(
        "w-full gap-2 items-center transition-opacity px-2 chat77submodule-recorder",
