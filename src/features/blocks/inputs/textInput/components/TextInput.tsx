...
import { defaultTextInputOptions } from "@chat77npm/blocks-inputs/text/constants";
import type { TextInputBlock } from "@chat77npm/blocks-inputs/text/schema";
import { getRuntimeVariable } from "@chat77npm/env/getRuntimeVariable";
import { isDefined } from "@chat77npm/lib/utils";
...
export const TextInput = (props: Props) => {
  ...
  return (
    <div
      class={clsx(
        "chat77submodule-input-form flex w-full gap-2 items-end",
    ...
    >
      <div
        class={clsx(
          "relative chat77submodule-input flex-col w-full",
          isDraggingOver() && "filter brightness-95",
        )}
      >
        <VoiceRecorder
          recordingStatus={recordingStatus()}
          buttonsTheme={props.context.chat77submodule.theme.chat?.buttons}
