...
import { defaultDateInputOptions } from "@chat77npm/blocks-inputs/date/constants";
...
export const DateForm = (props: Props) => {
  ...
  return (
    <div class="chat77submodule-input-form flex gap-2 items-end">
      <form
        class={clsx(
          "flex chat77submodule-input",
      ...
      >
        <div class="flex flex-col">
          ...
          >
            ...
            <input
              class="focus:outline-none flex-1 w-full text-input chat77submodule-date-input"
              style={{
                "min-height": "32px",
                "min-width": "100px",
                "font-size": "16px",
          ...
          {props.options?.isRange && (
            <div class="flex items-center p-4">
              ...
              <input
                class="focus:outline-none flex-1 w-full text-input ml-2 chat77submodule-date-input"
                style={{
                  "min-height": "32px",
                  "min-width": "100px",
                  "font-size": "16px",
