...
import { isDefined, isNotEmpty, isSvgSrc } from "@chat77npm/lib/utils";
        ...
        <For each={filteredItems()}>
          {(item, index) => (
            <button
              ...
              data-itemid={item.id}
              class={
                "flex flex-col chat77submodule-picture-button focus:outline-none filter hover:brightness-90 active:brightness-75 justify-between  " +
