...
import { defaultPictureChoiceOptions } from "@chat77npm/blocks-inputs/pictureChoice/constants";
  ...
  return (
    <form class="flex flex-col gap-2 w-full items-end" onSubmit={handleSubmit}>
      <Show when={props.options?.isSearchable}>
        <div class="flex items-end chat77submodule-input w-full">
          <SearchInput
            ref={inputRef}
            onInput={filterItems}
            placeholder={
        ...
        <For each={filteredItems()}>
          {(item, index) => (
            <div
              ...
              class={
                "flex flex-col focus:outline-none cursor-pointer select-none chat77submodule-selectable-picture" +
        ...
        >
          {(selectedItem, index) => (
            <div
              ...
              class={
                "flex flex-col focus:outline-none cursor-pointer select-none chat77submodule-selectable-picture selected"
              }
