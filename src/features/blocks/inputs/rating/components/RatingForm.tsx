...
import { defaultRatingInputOptions } from "@chat77npm/blocks-inputs/rating/constants";
import type { RatingInputBlock } from "@chat77npm/blocks-inputs/rating/schema";
import { isDefined, isEmpty, isNotDefined } from "@chat77npm/lib/utils";
      ...
      >
        ...
        <Show when={!props.isOneClickSubmitEnabled}>
          <div
            ...
            class={
              "py-2 px-4 font-semibold focus:outline-none cursor-pointer select-none chat77submodule-selectable" +
