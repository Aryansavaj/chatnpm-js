...
} from "@chat77npm/blocks-bubbles/video/constants";
import type {
  EmbeddableVideoBubbleContentType,
  VideoBubbleBlock,
} from "@chat77npm/blocks-bubbles/video/schema";
  ...
  return (
    ...
    >
      <div class="flex w-full items-center">
        <div class="flex relative z-10 items-start chat77submodule-host-bubble overflow-hidden w-full max-w-full">
          <div
