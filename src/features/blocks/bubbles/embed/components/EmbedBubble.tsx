...
import { defaultEmbedBubbleContent } from "@chat77npm/blocks-bubbles/embed/constants";
  ...
  return (
    ...
    >
      <div class="flex w-full items-center">
        <div class="flex relative z-10 items-start chat77submodule-host-bubble w-full max-w-full">
          <div
