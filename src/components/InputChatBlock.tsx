...
import { InputBlockType } from "@chat77npm/blocks-inputs/constants";
...
import { defaultPaymentInputOptions } from "@chat77npm/blocks-inputs/payment/constants";
...
import { defaultGuestAvatarIsEnabled } from "@chat77npm/theme/constants";
...
export const InputChatBlock = (props: Props) => {
  const [answer, setAnswer] = persist(createSignal<InputSubmitContent>(), {
    key: `chat77submodule-${props.context.chat77submodule.id}-input-${props.chunkIndex}`,
  ...
  return (
    <Switch>
      ...
      <Match when={isNotDefined(answer()) || props.hasError}>
        <div
          class="flex justify-end animate-fade-in gap-2 chat77submodule-input-container"
