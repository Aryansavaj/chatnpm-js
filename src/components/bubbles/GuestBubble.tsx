...
const TextGuestBubble = (props: { answer: TextInputSubmitContent }) => {
  ...
  return (
    <div class="flex flex-col gap-1 items-end">
          ...
          >
            {(attachment, idx) => (
              <img
                ...
                class={clsx(
                  "chat77submodule-guest-bubble-image-attachment cursor-pointer",
      ...
      <div
        class="p-[1px] whitespace-pre-wrap max-w-full chat77submodule-guest-bubble flex flex-col"
...
const AudioGuestBubble = (props: { answer: RecordingInputSubmitContent }) => {
  return (
    <div class="flex flex-col gap-1 items-end">
      <div
        class="p-2 w-full whitespace-pre-wrap chat77submodule-guest-bubble flex flex-col"
        data-testid="guest-bubble"
      >
