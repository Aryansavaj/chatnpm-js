...
export const StreamingBubble = (props: Props) => {
  const [content, setContent] = persist(createSignal<string[]>([]), {
    key: `chat77submodule-streaming-message-${props.streamingMessageId}`,
  ...
  return (
    <div class="flex flex-col animate-fade-in chat77submodule-streaming-container">
      <div class="flex w-full items-center">
        <div class="flex relative items-start chat77submodule-host-bubble max-w-full">
          <div
